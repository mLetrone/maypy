...
Valuated _Maybe_ is quite straightforward, provide some value whatever it is, as long as is not `None` to [`of`:octicons-link-external-16:](maybe.md#maybe._maybe.Maybe.of) .
...
Either by using [`is_present`:octicons-link-external-16:](maybe.md#maybe._maybe.Maybe.is_present)
to know if the container has a value 
or use [`is_empty`:octicons-link-external-16:](maybe.md#maybe._maybe.Maybe.is_empty) to verify the absence of value.
...
To retrieve the value contained inside a _Maybe_, the method [`get`:octicons-link-external-16:](maybe.md#maybe._maybe.Maybe.get)
returns it or raises an [`EmptyMaybeException`:octicons-link-external-16:](exceptions.md#maybe._exceptions.EmptyMaybeException).
...
When _Maybe_ is empty, it's possible to provide a default value using [`or_else`:octicons-link-external-16:](maybe.md#maybe._maybe.Maybe.or_else).
Taking either a value or a [`Supplier`:octicons-link-external-16:](functional.md#maybe._functional.Supplier) 
...
[`or_else_raise`:octicons-link-external-16:](maybe.md#maybe._maybe.Maybe.or_else_raise) when _Maybe_ is empty.
...
It is possible to perform inline condition on our wrapped value with [`filter`:octicons-link-external-16:](maybe.md#maybe._maybe.Maybe.filter).
Taking a [`Predicate`:octicons-link-external-16:](functional.md#maybe._functional.Predicate), it will check if the value matches the predicate and returning _Maybe_ itself when passing, otherwise an empty _Maybe_ is returned.
...
[`map`:octicons-link-external-16:](maybe.md#maybe._maybe.Maybe.map).
...
The last method is [`if_present`:octicons-link-external-16:](maybe.md#maybe._maybe.Maybe.if_present),
